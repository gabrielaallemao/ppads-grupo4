...
import 'editardispositivo_model.dart';
export 'editardispositivo_model.dart';

class EditardispositivoWidget extends StatefulWidget {
  const EditardispositivoWidget({
    super.key,
  ...
  static String routeName = 'editardispositivo';
  static String routePath = '/editardispositivo';

  @override
  State<EditardispositivoWidget> createState() =>
      _EditardispositivoWidgetState();
}

class _EditardispositivoWidgetState extends State<EditardispositivoWidget> {
  late EditardispositivoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditardispositivoModel());
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<CalculoDispositivosRow>>(
      future: CalculoDispositivosTable().querySingleRow(
      ...
      builder: (context, snapshot) {
        ...
        List<CalculoDispositivosRow>
            editardispositivoCalculoDispositivosRowList = snapshot.data!;

        final editardispositivoCalculoDispositivosRow =
            editardispositivoCalculoDispositivosRowList.isNotEmpty
                ? editardispositivoCalculoDispositivosRowList.first
                : null;
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: TextFormField(
                              controller:
                                  _model.nomedodispositivoTextController ??=
                                      TextEditingController(
                                text: editardispositivoCalculoDispositivosRow
                                    ?.nome,
                              ),
                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: TextFormField(
                                          controller:
                                              _model.wattsTextController ??=
                                                  TextEditingController(
                                            text:
                                                editardispositivoCalculoDispositivosRow
                                                    ?.watts
                                                    ?.toString(),
                                          ),
                          ...
                          Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                await CalculoDispositivosTable().update(
                                  data: {
                                    'nome': _model
                                        .nomedodispositivoTextController.text,
                                  ...
                                  matchingRows: (rows) => rows.eqOrNull(
                                    'id',
                                    editardispositivoCalculoDispositivosRow?.id,
                                  ),
                                );
                                await showDialog(
                                  context: context,
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
                                      title: Text('Dispositivo atualizado!'),
                                      actions: [
                                        TextButton(
                                          onPressed: () =>
