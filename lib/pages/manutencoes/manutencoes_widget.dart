...
class ManutencoesWidget extends StatefulWidget {
  const ManutencoesWidget({super.key});

  static String routeName = 'manutencoes';
  static String routePath = '/manutencoes';

  @override
  State<ManutencoesWidget> createState() => _ManutencoesWidgetState();
}

class _ManutencoesWidgetState extends State<ManutencoesWidget> {
  late ManutencoesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ManutencoesModel());
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<LembretesManutencaoRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<LembretesManutencaoRow> manutencoesLembretesManutencaoRowList =
            snapshot.data!;
                ...
                children: [
                  Padding(
                    ...
                    child: Builder(
                      builder: (context) {
                        final manutencoes =
                            manutencoesLembretesManutencaoRowList.toList();
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          highlightColor: Colors.transparent,
                                          onTap: () async {
                                            await LembretesManutencaoTable()
                                                .delete(
                                              matchingRows: (rows) =>
                                                  rows.eqOrNull(
                                                'id',
                                      ...
                                      InkWell(
                                        ...
                                        onTap: () async {
                                          context.pushNamed(
                                            EditarmanutencaoWidget.routeName,
                                            queryParameters: {
                                              'idLembrete': serializeParam(
                                                manutencoesItem.id,
                                                ParamType.int,
                                              ),
                                            }.withoutNulls,
